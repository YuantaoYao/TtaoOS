...
PUBLIC TASK sys_task_table[NR_SYS_TASKS_PROC] = {{task_tty, STACK_SIZE_TTY_TASK, "task_tty"}}; //系统任务
...
PUBLIC system_call sys_call_table[NR_SYS_CALL] = {sys_printx, sys_get_ticks, sys_write, sys_send_rec}; // 系统调用 （通过中断实现）
